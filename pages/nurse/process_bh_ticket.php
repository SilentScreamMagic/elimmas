...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO baby_head_ticket (
        apt_id, father_name, father_address, 
...
echo print_r($_POST);
    ...
    `FName`, `LName`, `DOB`, `gender`, `financial_type`, 
...
SELECT 
    ...
    '2026-08-01',     
    'Male',           
    `financial_type`, `emergency_fname`, `emergency_lname`, `marital_status`, 
    `address`, Null, `patient_email`, `emergency_phone`, 
...
$conn->execute_query($sql);
    ...
    //header("Location: baby_head_ticket.php?id=$stmt->insert_id"); 
}
